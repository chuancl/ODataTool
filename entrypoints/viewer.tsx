...
import { Box, Layers, ArrowLeft, ArrowRight, RefreshCw, Code, Database } from 'lucide-react';
import { ODataSchema, ViewerState } from '../types';
  ...
  const init = async () => {
    ...
    try {
      ...
      if (sourceType === 'storage') {
        ...
        // 尝试获取 URL 内容
        // 注意：如果是在 viewer.html 页面中 fetch，可能会遇到 CORS。
        // 对于插件页面，跨域能力取决于 host_permissions。
